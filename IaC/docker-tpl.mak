...
s1v2: $(LOG_DIR)/landlordv2.repo.log
...
$(LOG_DIR)/landlordv2.repo.log: ../code/service-landlord/v2/app.py ../code/service-landlord/v2/Dockerfile
	
	$(DK) build -t $(CREG)/$(REGID)/team-a-service-landlord:v2 ../code/service-landlord | tee $(LOG_DIR)/landlordv2.img.log
	#$(DK) push $(CREG)/$(REGID)/team-a-service-landlord:v2 | tee $(LOG_DIR)/landlordv2.repo.log
